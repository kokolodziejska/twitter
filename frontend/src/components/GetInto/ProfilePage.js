    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                setPhone(phoneResponse.data.email || "No phone available"); // Użyj właściwego klucza
                    ...
                    <div>
                        <div className="profile-cointeinetr">
                            ...
                            <div className="profile-edit-buttons">
                                ...
                                <button className="profile-edit-button">Change password</button>
                            </div>
                            <div className="profile-number-of-post-container">
                                ...
                                <button className="profile-number-of-post-button">Go to your posts</button>
                            </div>
                        </div>
                    </div>
                </div>
